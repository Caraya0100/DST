...
namespace DST
{
    ...
    public class ReglasMatching
    {
        ...
        private Dictionary<string, string> ReglasHB()
        {
            ...
            reglas.Add("12", "Si HBS es promedio y HBT es bajas entonces HB es no_compatibles");
            ...
            reglas.Add("18", "Si HBS es altas y HBT es promedio entonces HB es no_compatibles");
            ...
            reglas.Add("24", "Si HBS es muy_altas y HBT es altas entonces HB es no_compatibles");
        ...
        private Dictionary<string, string> ReglasHD()
        {
            ...
            reglas.Add("12", "Si HDS es promedio y HDT es bajas entonces HD es no_compatibles");
            ...
            reglas.Add("18", "Si HDS es altas y HDT es promedio entonces HD es no_compatibles");
            ...
            reglas.Add("24", "Si HDS es muy_altas y HDT es altas entonces HD es no_compatibles");
        ...
        private Dictionary<string, string> ReglasCF()
        {
            ...
            reglas.Add("12", "Si CFS es promedio y CFT es bajas entonces CF es no_compatibles");
            ...
            reglas.Add("18", "Si CFS es altas y CFT es promedio entonces CF es no_compatibles");
            ...
            reglas.Add("24", "Si CFS es muy_altas y CFT es altas entonces CF es no_compatibles");
        ...
        private Dictionary<string, string> ReglasCapacidad()
        {
            ...
            reglas.Add("2", "Si HB es no_compatibles y HD es no_compatibles y CF es compatibles entonces trabajador es no_capacitado");
            reglas.Add("3", "Si HB es no_compatibles y HD es no_compatibles y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("4", "Si HB es no_compatibles y HD es compatibles y CF es no_compatibles entonces trabajador es no_capacitado");
            reglas.Add("5", "Si HB es no_compatibles y HD es compatibles y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("6", "Si HB es no_compatibles y HD es compatibles y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("7", "Si HB es no_compatibles y HD es exceden y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("8", "Si HB es no_compatibles y HD es exceden y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("9", "Si HB es no_compatibles y HD es exceden y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("10", "Si HB es compatibles y HD es no_compatibles y CF es no_compatibles entonces trabajador es no_capacitado");
            reglas.Add("11", "Si HB es compatibles y HD es no_compatibles y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("12", "Si HB es compatibles y HD es no_compatibles y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("13", "Si HB es compatibles y HD es compatibles y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("14", "Si HB es compatibles y HD es compatibles y CF es compatibles entonces trabajador es capacitado");
            reglas.Add("15", "Si HB es compatibles y HD es compatibles y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("16", "Si HB es compatibles y HD es exceden y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("17", "Si HB es compatibles y HD es exceden y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("18", "Si HB es compatibles y HD es exceden y CF es exceden entonces trabajador es sobre_capacitado");
            reglas.Add("19", "Si HB es exceden y HD es no_compatibles y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("20", "Si HB es exceden y HD es no_compatibles y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("21", "Si HB es exceden y HD es no_compatibles y CF es exceden entonces trabajador es medianamente_capacitado");
            reglas.Add("22", "Si HB es exceden y HD es compatibles y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("23", "Si HB es exceden y HD es compatibles y CF es compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("24", "Si HB es exceden y HD es compatibles y CF es exceden entonces trabajador es sobre_capacitado");
            reglas.Add("25", "Si HB es exceden y HD es exceden y CF es no_compatibles entonces trabajador es medianamente_capacitado");
            reglas.Add("26", "Si HB es exceden y HD es exceden y CF es compatibles entonces trabajador es sobre_capacitado");
            reglas.Add("27", "Si HB es exceden y HD es exceden y CF es exceden entonces trabajador es sobre_capacitado");
