...
namespace DST
{
    ...
    public class ReglasMatching
    {
        ...
        private Dictionary<string, string> ReglasCapacidad()
        {
            ...
            reglas.Add("9", "Si HB es inferiores y HD es superiores y CF es superiores entonces trabajador es medianamente_capacitado");
            ...
            reglas.Add("15", "Si HB es iguales y HD es iguales y CF es superiores entonces trabajador es medianamente_capacitado");
            reglas.Add("16", "Si HB es iguales y HD es superiores y CF es inferiores entonces trabajador es medianamente_capacitado");
            reglas.Add("17", "Si HB es iguales y HD es superiores y CF es iguales entonces trabajador es medianamente_capacitado");
            ...
            reglas.Add("22", "Si HB es superiores y HD es iguales y CF es inferiores entonces trabajador es medianamente_capacitado");
            reglas.Add("23", "Si HB es superiores y HD es iguales y CF es iguales entonces trabajador es medianamente_capacitado");
            reglas.Add("24", "Si HB es superiores y HD es iguales y CF es superiores entonces trabajador es sobre_capacitado");
            reglas.Add("25", "Si HB es superiores y HD es superiores y CF es inferiores entonces trabajador es medianamente_capacitado");
